    ...
    protected override IComponent[] Setup(out NoExpose exposed)
    {
        ...
        [
            ...
            new SectionTitle
            {
                ...
                {
                    Text = "Creating a Natrix Application".ToConstSignal(),
                    Id = "creating-a-natrix-application".ToConstSignal(),
                },
                Slots = new SectionTitleSlots
                {
                    ...
                    [
                        ...
                        new CliCommand
                        {
                            ...
                            {
                                Label = "Install Natrix template using the following command:".ToConstSignal(),
                                Command = "dotnet new install Natrix.Templates".ToConstSignal(),
                            },
                        },
                    ],
                },
