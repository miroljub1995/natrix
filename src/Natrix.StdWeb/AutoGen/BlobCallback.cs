...
public delegate void BlobCallbackManaged(global::Natrix.StdWeb.Blob? blob);

public partial class BlobCallback: global::Natrix.JSCore.JSObjectProxy
{
    ...
    {
        return new global::Natrix.StdWeb.BlobCallback(ToJSObject(input));
    }

    [global::System.Runtime.Versioning.SupportedOSPlatform("browser")]
    public bool TryGetManaged([global::System.Diagnostics.CodeAnalysis.NotNullWhenAttribute(true)] out global::Natrix.StdWeb.BlobCallbackManaged? managed, bool allowConversion = false)
    {
        managed = global::Natrix.JSCore.Extensions.JSFunctionExtensions.GetManagedFunctionFromProperty(JSObject) as global::Natrix.StdWeb.BlobCallbackManaged;
        ...
        managed = (blob) =>
        {
            ...
            {
                global::Natrix.StdWeb.Blob ___notNullable_5 = (global::Natrix.StdWeb.Blob)blob;
    ...
    private static global::System.Runtime.InteropServices.JavaScript.JSObject ToJSObject(BlobCallbackManaged input)
    {
        Action<global::System.Runtime.InteropServices.JavaScript.JSObject> callback = (___args_0) =>
        {
            ...
            {
                // Argument 1
                global::Natrix.StdWeb.Blob? ___arg_2;
                ...
                else
                {
                    ...
                    ___arg_2 = global::Natrix.JSCore.JSObjectProxyFactory.GetProxy<global::Natrix.StdWeb.Blob>(___notNullable_4);
                }
        ...
        global::System.Runtime.InteropServices.JavaScript.JSObject ___funcObj_5 = global::Natrix.JSCore.Extensions.JSFunctionExtensions.WrapAsVoidFunction(callback);
