...
public partial class RemotePlaybackAvailabilityCallback: global::Natrix.JSCore.JSObjectProxy
{
    ...
    {
        return new global::Natrix.StdWeb.RemotePlaybackAvailabilityCallback(ToJSObject(input));
    }

    [global::System.Runtime.Versioning.SupportedOSPlatform("browser")]
    public bool TryGetManaged([global::System.Diagnostics.CodeAnalysis.NotNullWhenAttribute(true)] out global::Natrix.StdWeb.RemotePlaybackAvailabilityCallbackManaged? managed, bool allowConversion = false)
    {
        managed = global::Natrix.JSCore.Extensions.JSFunctionExtensions.GetManagedFunctionFromProperty(JSObject) as global::Natrix.StdWeb.RemotePlaybackAvailabilityCallbackManaged;
        ...
        managed = (available) =>
        {
            ...
            global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.SetPropertyAsBooleanV2(___argsArray_0.JSObject, 0, ___marshalledValue_4);
    ...
    private static global::System.Runtime.InteropServices.JavaScript.JSObject ToJSObject(RemotePlaybackAvailabilityCallbackManaged input)
    {
        Action<global::System.Runtime.InteropServices.JavaScript.JSObject> callback = (___args_0) =>
        {
            using (___args_0)
            {
                // Argument 1
                bool ___arg_2;
                bool ___res_3 = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsBooleanV2(___args_0, 0);
                ___arg_2 = ___res_3;
