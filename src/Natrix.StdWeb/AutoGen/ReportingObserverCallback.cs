...
public partial class ReportingObserverCallback: global::Natrix.JSCore.JSObjectProxy
{
    ...
    {
        return new global::Natrix.StdWeb.ReportingObserverCallback(ToJSObject(input));
    }

    [global::System.Runtime.Versioning.SupportedOSPlatform("browser")]
    public bool TryGetManaged([global::System.Diagnostics.CodeAnalysis.NotNullWhenAttribute(true)] out global::Natrix.StdWeb.ReportingObserverCallbackManaged? managed, bool allowConversion = false)
    {
        managed = global::Natrix.JSCore.Extensions.JSFunctionExtensions.GetManagedFunctionFromProperty(JSObject) as global::Natrix.StdWeb.ReportingObserverCallbackManaged;
    ...
    private static global::System.Runtime.InteropServices.JavaScript.JSObject ToJSObject(ReportingObserverCallbackManaged input)
    {
        Action<global::System.Runtime.InteropServices.JavaScript.JSObject> callback = (___args_0) =>
        {
            using (___args_0)
            {
                ...
                ___arg_4 = global::Natrix.JSCore.JSObjectProxyFactory.GetProxy<global::Natrix.StdWeb.ReportingObserver>(___res_5);
