...
public delegate global::Natrix.JSCore.Promise UnderlyingSinkWriteCallbackManaged(global::Natrix.JSCore.Generics.Union<double, global::System.Numerics.BigInteger, string, bool, global::System.Runtime.InteropServices.JavaScript.JSObject, object, global::Natrix.StdWeb.GenericMarshaller.Union>? chunk, global::Natrix.StdWeb.WritableStreamDefaultController controller);

public partial class UnderlyingSinkWriteCallback: global::Natrix.JSCore.JSObjectProxy
{
    ...
    {
        return new global::Natrix.StdWeb.UnderlyingSinkWriteCallback(ToJSObject(input));
    }

    [global::System.Runtime.Versioning.SupportedOSPlatform("browser")]
    public bool TryGetManaged([global::System.Diagnostics.CodeAnalysis.NotNullWhenAttribute(true)] out global::Natrix.StdWeb.UnderlyingSinkWriteCallbackManaged? managed, bool allowConversion = false)
    {
        managed = global::Natrix.JSCore.Extensions.JSFunctionExtensions.GetManagedFunctionFromProperty(JSObject) as global::Natrix.StdWeb.UnderlyingSinkWriteCallbackManaged;
        ...
        managed = (chunk, controller) =>
        {
            ...
            ___res_2 = new global::Natrix.JSCore.Promise(___propObject_6);
            return ___res_2;
        };
        return true;
    }
    ...
    private static global::System.Runtime.InteropServices.JavaScript.JSObject ToJSObject(UnderlyingSinkWriteCallbackManaged input)
    {
        Action<global::System.Runtime.InteropServices.JavaScript.JSObject, global::System.Runtime.InteropServices.JavaScript.JSObject> callback = (___args_0, ___res_7) =>
        {
            ...
            using (___res_7)
            {
                ...
                // Argument 2
                global::Natrix.StdWeb.WritableStreamDefaultController ___arg_4;
                ...
                ___arg_4 = global::Natrix.JSCore.JSObjectProxyFactory.GetProxy<global::Natrix.StdWeb.WritableStreamDefaultController>(___res_5);

                global::Natrix.JSCore.Promise ___managedRes_8 = input(___arg_2, ___arg_4);
