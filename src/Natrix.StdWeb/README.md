...
- Integration with [Natrix.JSCore](../Natrix.JSCore/) for proxy creation, type marshalling, JavaScript object lifetime, and callback interop.
...
The generated sources live under [AutoGen](AutoGen/) and are produced by [../Natrix.WebIDLGenerator](../Natrix.WebIDLGenerator/). The generator consumes curated WebIDL definitions from the repository's [../../submodules/webref](../../submodules/webref/) submodule.
