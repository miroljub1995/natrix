            ...
            new Section
            {
                ...
                [
                    new H1
                    {
                        ...
                        Children = [new DomText { Text = "Build with Natrix".ToConstSignal() }],
                    },
                    new P
                    {
                        Props = new PProps
                        ...
                        [
                            new DomText
                            {
                                Text = "This project was generated with the natrix template and includes server-side rendering, hydration, routing, and Tailwind CSS.".ToConstSignal(),
                            },
                        ],
                    },
                    new Div
