...
public partial class TestCallbackPropertiesCallback: global::Natrix.JSCore.JSObjectProxy
{
    ...
    {
        return new global::Natrix.WebIDLGenerator.Tests.TestCallbackPropertiesCallback(ToJSObject(input));
    }

    [global::System.Runtime.Versioning.SupportedOSPlatform("browser")]
    public bool TryGetManaged([global::System.Diagnostics.CodeAnalysis.NotNullWhenAttribute(true)] out global::Natrix.WebIDLGenerator.Tests.TestCallbackPropertiesCallbackManaged? managed, bool allowConversion = false)
    {
        managed = global::Natrix.JSCore.Extensions.JSFunctionExtensions.GetManagedFunctionFromProperty(JSObject) as global::Natrix.WebIDLGenerator.Tests.TestCallbackPropertiesCallbackManaged;
