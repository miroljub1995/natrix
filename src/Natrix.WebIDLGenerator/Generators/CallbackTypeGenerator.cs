    ...
    private string GetConvertToJS(CallbackType input)
    {
        ...
        for (var i = 0; i < input.Arguments.Count; i++)
        {
            ...
            else
            {
                ...
                argStatements.Add(
                    $$"""
                      // Argument {{i + 1}}
                      int {{lengthVar}} = global::System.Convert.ToInt32(global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsDoubleV2({{argsVar}}, "length"));
        ...
        if (input.IdlType is SingleTypeDescription { IdlType: BuiltinTypes.Undefined })
        {
            return $$"""
                     ...
                     global::System.Runtime.InteropServices.JavaScript.JSObject {{funcObjVar}} = global::Natrix.JSCore.Extensions.JSFunctionExtensions.WrapAsVoidFunction(callback);
                     global::Natrix.JSCore.Extensions.JSFunctionExtensions.StoreManagedFunctionToProperty({{funcObjVar}}, input);
        ...
        else
        {
            ...
            return $$"""
                     ...
                     global::System.Runtime.InteropServices.JavaScript.JSObject {{funcObjVar}} = global::Natrix.JSCore.Extensions.JSFunctionExtensions.WrapAsNonVoidFunction(callback);
                     global::Natrix.JSCore.Extensions.JSFunctionExtensions.StoreManagedFunctionToProperty({{funcObjVar}}, input); 
    ...
    private string GetTryGetManaged(CallbackType input)
    {
        ...
        if (!isVoid)
        {
            managedStatements.Add(
                $"using global::Natrix.JSCore.FunctionResPool.Owner {resOwnerVar} = global::Natrix.JSCore.FunctionResPool.Shared.Rent();");
        }
        ...
        if (isEmpty)
        {
            ...
            {
                managedStatements.Add(
                    $"global::Natrix.JSCore.Extensions.JSFunctionExtensions.CallEmptyNonVoidFunction(JSObject, null, {resOwnerVar}.JSObject);");
            }
        }
        else
        {
            ...
            {
                managedStatements.Add(
                    $"global::Natrix.JSCore.Extensions.JSFunctionExtensions.CallNonEmptyVoidFunction(JSObject, null, {argsArrayVar}.JSObject);");
            }
            else
            {
                managedStatements.Add(
                    $"global::Natrix.JSCore.Extensions.JSFunctionExtensions.CallNonEmptyNonVoidFunction(JSObject, null, {argsArrayVar}.JSObject, {resOwnerVar}.JSObject);");
            }
        }
        ...
        return $$"""
                 managed = global::Natrix.JSCore.Extensions.JSFunctionExtensions.GetManagedFunctionFromProperty(JSObject) as global::{{genSettings.Namespace}}.{{input.Name}}Managed;
