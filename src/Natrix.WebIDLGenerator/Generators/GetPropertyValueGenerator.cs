using Natrix.WebIDLGenerator.Marshallers;
...
)
{
    ...
    )
    {
        ...
        if (type.IdlType is BuiltinTypes.BigInt)
        {
            ...
            getPropertyContent = $$"""
                                   global::System.Numerics.BigInteger{{nullableTypeSuffix}} {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsBigIntegerV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
        }
        else if (type.IdlType is BuiltinTypes.Boolean)
        {
            ...
            getPropertyContent = $$"""
                                   bool{{nullableTypeSuffix}} {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsBooleanV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
        }
        else if (type.IdlType is BuiltinTypes.String)
        {
            ...
            getPropertyContent = $$"""
                                   string{{nullableTypeSuffix}} {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsStringV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
        }
                ...
                )
        {
            ...
            getPropertyContent = $$"""
                                   double{{nullableTypeSuffix}} {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsDoubleV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
        }
        else if (type.IdlType is BuiltinTypes.ManagedObject)
        {
            ...
            getPropertyContent = $$"""
                                   object{{nullableTypeSuffix}} {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsObjectV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
        }
        ...
        else
        {
            ...
            getPropertyContent = $$"""
                                   global::System.Runtime.InteropServices.JavaScript.JSObject{{nullableTypeSuffix}} {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsJSObjectV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
        }
    ...
    )
    {
        ...
        var getPropertyContent = $$"""
                                   {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsJSObjectV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
    ...
    )
    {
        ...
        var getPropertyContent = $$"""
                                   {{getPropertyVar}} = global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsUnionV2{{asNullableSuffix}}({{inputVar}}, {{propertyNameVar}});
                                   """;
