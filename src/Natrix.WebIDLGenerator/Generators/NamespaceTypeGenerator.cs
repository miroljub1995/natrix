...
)
{
    public string Generate(NamespaceType input)
    {
            ...
            exposedInterfacesParts.Add(
                $$"""
                  public partial class {{interfaceType.Name}}
                  {
                      ...
                      public global::{{genSettings.Namespace}}.{{className}} {{propertyName}} => new global::{{genSettings.Namespace}}.{{className}}(global::Natrix.JSCore.Extensions.JSObjectPropertyExtensions.GetPropertyAsJSObjectV2(JSObject, "{{input.Name}}"));
                  }
                  """
            );
        }
        ...
        var content = $$"""
                        ...
                        public partial class {{className}}: global::Natrix.JSCore.JSObjectProxy
                        {
                            [global::System.Runtime.Versioning.SupportedOSPlatform("browser")]
